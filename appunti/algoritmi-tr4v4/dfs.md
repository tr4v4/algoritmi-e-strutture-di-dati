...
## Alberi
- [[albero-binario-dfs|Albero binario#DFS]]

## Osservazione
Nota come l'approccio DFS, a differenza del [[bfs|BFS]], non abbia bisogno nell'implementazione pratica di una [[struttura-dati|struttura dati]] d'appoggio come la [[pila|pila]], perché **utilizza lo [[stack|stack]] stesso della macchina come struttura per visitare alberi e grafi in profondità**.
